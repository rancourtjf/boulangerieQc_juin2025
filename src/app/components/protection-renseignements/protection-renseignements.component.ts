import { Component, OnInit, inject, signal } from '@angular/core';import {MatExpansionModule} from '@angular/material/expansion';
...
import { AccordionRensComponent } from 'src/app/components/accordion-rens/accordion-rens.component';
@Component({
  selector: 'app-protection-renseignements',
  standalone:true,
  imports:[AccordionRensComponent],
  templateUrl: './protection-renseignements.component.html',
  styleUrls: ['./protection-renseignements.component.css']
})
export class ProtectionRenseignementsComponent {
