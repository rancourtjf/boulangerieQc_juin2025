...
@Component({
  ...
  templateUrl: "./voir-recettes.component.html",
  styleUrl: "./voir-recettes.component.css",
})
export class VoirRecettesComponent implements AfterViewInit, OnInit {
  @ViewChild(MatSort)
  ...
  constructor(  ) {
    ...
    console.log("on entre dans constructor voir-recettes");
