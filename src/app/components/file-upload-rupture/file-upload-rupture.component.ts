...
import { HeureRuptureComponent } from "src/app/components/heure-rupture/heure-rupture.component";
...
@Component({
  selector: 'app-file-upload-rupture',
  standalone: true,
  imports: [CommonModule, FormsModule, ReactiveFormsModule],
  templateUrl: './file-upload-rupture.component.html',
  styleUrl: './file-upload-rupture.component.css'
})
export class FileUploadRuptureComponent implements OnInit  {

  http = inject(HttpClient);
  fileService = inject(FileuploadCommandesService);
  api = inject(ApiService);
  rupture=inject(HeureRuptureComponent)
  fileName: any;
  ...
  onUpload() {
    this.loading.set(!this.loading());
       this.simpleAlertConfirm(
          "Sélection du fichier faite et  envoyée à " + this.extract.boulanger.emailEnvoiAuBoulanger + " !"
        );
