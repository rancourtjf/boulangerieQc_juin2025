...
//$jwt = htmlspecialchars(trim($data->tokenAuth));
...
//   if (isset($noEquipe)) {
//     $noEquipe= filter_var($noEquipe, FILTER_VALIDATE_INT, [
//         'options' => [
//             'default' => 'all_client',
//             'min_range' => 1
//         ]
...
try {
   ...
   // $sql = is_numeric($noEquipe) ? "SELECT * FROM equipes WHERE id='$noEquipe'" : "SELECT * FROM equipes ORDER BY nomEquipe ASC";
    $sql =  "SELECT * FROM equipes ORDER BY nomEquipe ASC";
