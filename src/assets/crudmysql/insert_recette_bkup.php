...
try {
    ...
    $temperature_pate = htmlspecialchars(trim($data->temperature_pate));
    ...
    $query = "INSERT INTO recettes(ID_recette,
    nom_recette,
    ingredients,
    etapesboulange,
    prix_client_parkg,
    prix_total_cost_client,
    avis_allergene,
    consistance,
    categorie,
    liste_ingredients_lineaire,
    poolish,
    ingredients_poolish,
    ingredients_petrissee,
    type_poolish,
    duree_poolish,
    qtelevure_poolish,
    cout_de_revient_reel_parkg,
    cout_main_oeuvre_parkg,
    farinepoolish,
    eaupoolish,
    levurepoolish,
    selpoolish,
    ...
    faconnage,
    appret_min,
    cuissontempsapprox_min,
    cuissontemperature_celcius,
    prix_total_cost,
    prix_recette_kgpate,
    taxable,
    bassinage,
...
echo "query=".$query;
    ...
    $stmt->bindValue(':etapesbouange', $etapesbouange, PDO::PARAM_STR);
    ...
    $stmt->bindValue(':temperature_pate', $temperature_pate, PDO::PARAM_STR);
