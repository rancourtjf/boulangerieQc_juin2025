...
try {
    ...
    $fetch_post = "SELECT * FROM `client` WHERE id=:id";
    ...
    if ($fetch_stmt->rowCount() > 0) :
        //echo 'AAA';
           ...
           $id = isset($data->$idclient) ? $data->$id : $row['id'];
           ...
           $logoSignal = isset($data->$logoSignal) ? $data->$logoSignal : $row['logoSignal'];
           ...
           $projetSherbrooke = isset($data->$projetSherbrooke) ? $data->$projetSherbrooke : $row['projetSherbrooke'];
    ...
    $query = "UPDATE  client SET
        ...
        nomBoulangerie=:nomBoulangerie,logoBoulangerie=:logoBoulangerie,role=:role,
        ...
        outilsGestion=:outilsGestion,projetSherbrooke=:projetSherbrooke,actif=:actif WHERE id=:id";
    ...
    if ($stmt->execute()) {
        ...
        echo json_encode([
            'success' => 1,
            'message' => 'Donnees mises a jour id='.$id.' '+$outilsGestion
        ]);
        exit;
    }
